...
export default function AdminLoginForm({ onLogin }: AdminLoginFormProps) {
    ...
    return (
        <div className="rounded-2xl w-[400px] p-8 flex flex-col items-center relative z-10">
            ...
            {view === 'login' && (
                <div className="w-full flex flex-col items-center">
                    <h1 className="text-3xl font-medium text-primary">Iniciar Sesión</h1>
                    ...
                    <button onClick={() => setView('recover')} className="text-[#5D9634] text-base mt-4 hover:underline">

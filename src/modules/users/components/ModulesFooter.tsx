  ...
  return (
    <footer className="w-full mt-auto pb-6 px-14 flex items-center justify-between gap-6 overflow-hidden">
      <div className="flex items-center gap-3 shrink-0">
        ...
        <span className="text-[10px] md:text-[11px] font-bold tracking-[0.25em] text-[#2d4a36] uppercase whitespace-nowrap">
      ...
      <span className="text-[10px] md:text-[11px] font-bold tracking-[0.25em] text-[#2d4a36] uppercase whitespace-nowrap shrink-0">

...
export default function UserProfilePanel({ onLogout }: UserProfilePanelProps) {
    return (
        <div className="flex flex-col items-center bg-white rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.06)] w-[360px] h-full relative overflow-hidden z-10">
            <div className="flex-1 w-full flex flex-col items-center justify-center">
                ...
                <h2 className="text-2xl font-bold text-[#1a2f22] mb-5">Usuario Normal</h2>
            ...
            <button 
                onClick={onLogout}
                className="absolute bottom-8 flex items-center gap-2 bg-[#6b9d3b] hover:bg-[#58852e] text-white px-5 py-2.5 rounded-xl font-medium shadow-md transition-colors"
            >
                Cerrar Sesión
                <LogOut size={16} />
            </button>
